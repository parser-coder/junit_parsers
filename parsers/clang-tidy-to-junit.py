#!/usr/bin/env python3
# start with: cat clang_tidy_output.txt| python clang-tidy-to-junit.py . > clang_tidy_junit.xml
...
{htmldata}
    ...
    def process_error(self, error_array):
        ...
        error = ErrorDescription(result.group(1), int(result.group(2)), int(
